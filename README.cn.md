...
合计: **119,840** 行代码（覆盖前 5 种语言、共 **722** 个文件）。
...
- **最新版本**: `v0.6.150` (2026-09-10)
- **最近提交**: 2026-09-10
- **Release 含资产**: 103 个

## 流行度

- **Star**: 5,045 · **Fork**: 609 · **开放 issue**: 631 · **贡献者**: 83

## 累计统计

- **发布数**: 441 · **已合并 PR**: 1725 · **开放 PR**: 68 · **已关闭 issue**: 217 · **开放 issue**: 414 · **提交数**: 2957

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-11 | 2 | 1 | 3 | 0 | 1 | 1 |
| last60d | 2026-07-12 | 3 | 2 | 8 | 0 | 9 | 2 |
| 90d | 2026-06-12 | 4 | 3 | 12 | 0 | 14 | 3 |
| last180d | 2026-03-14 | 12 | 15 | 33 | 2 | 20 | 20 |
| 360d | 2025-09-15 | 100 | 312 | 65 | 13 | 61 | 322 |
...
在 [repology.org](https://repology.org/project/digger) 上共有 **32** 个发行版报告此项目。**11** 个 ✅ 已是最新上游版本，**11** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260910.yml` · 2026-09-10T22:48:48Z._
